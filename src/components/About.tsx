            ...
            <div>
              ...
              <div className="space-y-4 text-gray-700 leading-relaxed">
                <p>
                  ...
                  MOTRAC Global Resources is a fully Nigerian-owned powerhouse
                  of business development creativity and consulting expertise.
                </p>
                <p>
                ...
                <p className="text-lg font-semibold text-gray-800">
                  ...
                  developing, and managing people capacities to carry on
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700 text-sm leading-relaxed">
                        To recognize potentials and develop capacities in
                        people, guaranteeing growth in government institutions,
                        businesses, and organizations.
                      </p>
                    </div>
                  </div>
                ...
                <div className="bg-gradient-to-r from-[#F23B11]/10 to-[#ff6844]/10 rounded-xl p-6 border-l-4 border-[#F23B11]">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700 text-sm leading-relaxed">
                        To become a world-class nurturing place for
                        transformation of individuals into effective and
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700 text-sm leading-relaxed">
                        ...
                        great imaginations, making it possible for humans to
                        achieve the superlative.
                      </p>
                    </div>
                  </div>
                </div>
