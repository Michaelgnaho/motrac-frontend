        ...
        <div className="flex flex-col items-start justify-center gap-8 max-w-5xl">
          ...
          <div className="w-full max-w-3xl">
            <p className="font-medium text-white text-lg sm:text-xl lg:text-2xl leading-relaxed">
              At Motrac Global Resources Limited, we recognize potentials and
              develop capacities in people, guaranteeing growth and development
              in businesses, organizations, and government institutions.
            </p>
          </div>
