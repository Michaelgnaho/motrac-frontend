        ...
        <div className="container mx-auto px-6 lg:px-12 pt-32 pb-16">
          ...
          >
            ...
            <p className="text-xl lg:text-2xl leading-relaxed max-w-5xl">
              ...
              deployment of creativity and consulting expertise, and saddled
              with business endeavors in the areas of Human Capital Development,
            ...
            <div>
              ...
              <div className="space-y-6 text-lg text-gray-700 leading-relaxed">
                <p>
                  ...
                  <span className="font-semibold text-[#F23B11]">2003</span>, as
                  a powerhouse of Business Development creativity and consulting
                  expertise, fully Nigerian owned, to recognize potentials and
                  develop capacities in people, guaranteeing growth in
                  Businesses and Organizations. It was recently re-incorporated
                  in the year{" "}
                ...
                <p>
                  ...
                  Consultancy industry. We are poised to deliver solutions to
                  our Clients&apos; Business development and Consultancy
            ...
            >
              <div className="bg-white rounded-2xl p-8 shadow-xl">
                ...
                <p className="text-gray-700 leading-relaxed">
                  ...
                  guaranteeing growth and development in Government
                  institutions, Businesses and Organizations in our areas of
                  competencies and the markets we serve.
                </p>
              </div>
            </AnimatedContent>
          ...
          >
            <div className="bg-gray-50 rounded-2xl p-8 lg:p-12 border-l-8 border-[#F23B11]">
              <p className="text-lg lg:text-xl text-gray-700 leading-relaxed mb-6">
                When an apple fell on the head of Isaac Newton, it created a
                whole new set of thinking which resulted in the innovation of
                such technological masterpieces as the airplane, the space
                shuttle etc.
              </p>
              <p className="text-lg lg:text-xl text-gray-700 leading-relaxed mb-6">
                With our team and affiliation of creative minds and networks, we
                tap into the strata of creative thinking, bringing to our
                clients and their brands fresh ideas and unique concepts that
                leverage them in their various markets.
              </p>
              <p className="text-lg lg:text-xl text-gray-700 leading-relaxed">
                ...
                by the zeal to succeed, to be second to none in what we do and
                to impact our immediate environment and creating visibility, by
